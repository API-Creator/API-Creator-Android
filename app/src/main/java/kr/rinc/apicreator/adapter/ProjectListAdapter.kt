 ...
 */
class ProjectListAdapter(private val context: Context, private val gson: List<getProject>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder?, position: Int) {
        ...
        val item = gson[position]
        gridViewHolder.itemView.projectTitle.text = item.title
        gridViewHolder.itemView.projectPM.text = "PM By " + item.owner.toString()
    }
}